...
game_status = "";
 ...
 function preload() {
  ...
  //load sound using--- loadSound("ball_touch_paddel.wav")
...
function gotPoses(results)
{
  if(results.length > 0)
  {
    // extract rightwrist using---- results[0].pose.rightWrist.y
...
if(pcscore ==4){
 ...
 // add--- ball.y+ball.r > height || ball.y-ball.r <0  in if condition
